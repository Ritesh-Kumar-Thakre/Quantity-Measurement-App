...
import com.apps.quantitymeasurement.reposistory.IQuantityMeasurementRepository;
...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
	...
	public boolean compare(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
		...
		repository.save(new QuantityMeasurementEntity(thisQuantityDTO, thatQuantityDTO,
				Operation.COMPARISION.toString(), result ? "EQUAL" : "NOT EQUAL"));
		return result;
	}
	...
	public QuantityDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
		...
		QuantityDTO q5 = new QuantityDTO(q4.getValue(), q1.getUnit().getUnitName(),
				q1.getUnit().getClass().getSimpleName());
		repository.save(
				new QuantityMeasurementEntity(thisQuantityDTO, thatQuantityDTO, Operation.CONVERSION.toString(), q5));
	...
	public QuantityDTO add(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
		...
		QuantityDTO q5 = new QuantityDTO(q4.getValue(), q3.getUnit().getUnitName(),
				q3.getUnit().getClass().getSimpleName());
		repository.save(
				new QuantityMeasurementEntity(thisQuantityDTO, thatQuantityDTO, Operation.ARITHMETIC.toString(), q5));
	...
	public QuantityDTO add(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO, QuantityDTO targetQuantityDTO) {
		...
		QuantityDTO q6 = new QuantityDTO(q5.getValue(), q5.getUnit().getUnitName(),
				q5.getUnit().getClass().getSimpleName());

		repository.save(
				new QuantityMeasurementEntity(thisQuantityDTO, thatQuantityDTO, Operation.ARITHMETIC.toString(), q6));
	...
	public QuantityDTO subtract(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
		...
		QuantityDTO q5 = new QuantityDTO(q4.getValue(), q4.getUnit().getUnitName(),
				q4.getUnit().getClass().getSimpleName());
		repository.save(
				new QuantityMeasurementEntity(thisQuantityDTO, thatQuantityDTO, Operation.ARITHMETIC.toString(), q5));
	...
	public QuantityDTO divide(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO) {
		...
		q3 = q3.division(q4);
		QuantityDTO q5 = new QuantityDTO(q3.getValue(), q3.getUnit().getUnitName(),
				q3.getUnit().getClass().getSimpleName());
	...
	public QuantityDTO divide(QuantityDTO thisQuantityDTO, QuantityDTO thatQuantityDTO, QuantityDTO targetQuantityDTO) {
		...
		QuantityDTO q6 = new QuantityDTO(q4.getValue(), q4.getUnit().getUnitName(),
				q4.getUnit().getClass().getSimpleName());
	...
	private void validateArithmeticOperation(QuantityModel<?> thisQuantityModel, QuantityModel<?> thatQuantityModel) {
		if (Double.isInfinite(thisQuantityModel.getValue()) || Double.isNaN(thisQuantityModel.getValue())
				|| Double.isInfinite(thatQuantityModel.getValue()) || Double.isNaN(thatQuantityModel.getValue())) {
