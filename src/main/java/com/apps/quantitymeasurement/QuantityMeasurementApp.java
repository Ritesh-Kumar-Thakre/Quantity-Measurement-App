...
public class QuantityMeasurementApp {
	...
	public static class Inches{
      ...
      public static void main(String[] args) throws InvalidUnitMeasurementException {
	   ...
	   System.out.println("Are lengths equals : "+ demonstrateLengthEquality(new Length(1,com.apps.quantitymeasurement.Length.LengthUnit.FEET),new Length(12,Length.LengthUnit.INCHES)));
